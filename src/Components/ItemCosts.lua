...
CARDS = {
  ...
  bicycle = { name = "Bicycle", cost = 16, desc = "- Bicycle: Double your movement for the turn. You may end your movement on any space you enter." },
  ...
  vitamin = { name = "Vitamin", cost = 25, desc = "- Vitamin: Add 1 to the final attack value of the attached Pokémon." },
  ...
  type_enhancer = { name = "Type Enhancer", cost = 14, desc = "- Type Enhancer: Draw 3 cards from the Type-Enhancer deck. Select 1 to keep and then place the rest on the bottom of the deck." },
  ...
  mega_stone = { name = "Mega Stone", cost = 8, desc = "- Mega Stone: You may only attach this to Pokémon capable of Mega Evolution. If this Pokémon Mega Evolves, it returns to its original state at the end of battle. Level gains for this Pokémon are given relative to its original state." },
  z_ring = { name = "Z-Ring", cost = 16, desc = "- Z-Ring: Draw 3 cards from the Z-Ring deck. Add 1 to your hand and then place the rest on the bottom of the deck." },

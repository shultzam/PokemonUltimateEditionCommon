...
gen9PokemonData =
{
  ...
  { name = "Skeledirge",    level = 5, types = { "Fire", "Ghost" }, moves = { "Shadow Ball", "Torch Song" }, guids = { "6b9ddf", "0528b7", "91d3a3" }, model_GUID = "e59cc3", custom_scale=0.7, offset={x=0, y=0.03, z=0} },

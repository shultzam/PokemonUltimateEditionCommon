--[[ 
    All of this code was taken from from the DnD Tools mod available on Steam. Credit to them, they are way smarter than me.
    This code is currently unused but could be used for a bunch of features. Namely, HP Rule 2 and health bars.
